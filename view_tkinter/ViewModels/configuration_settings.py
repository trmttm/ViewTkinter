...
def create_configuration_setting(frame, **kwargs):
    ...
    view_model = [
        ...
        wm('account_frame', entry_account_w, 'entry', 0, 0, 1, 1, 'nsew', **{'width': 3}),
        wm('account_frame', entry_account_h, 'entry', 0, 0, 2, 2, 'nsew', **{'width': 3}),
        wm('account_frame', entry_account_font_size, 'entry', 0, 0, 3, 3, 'nsew', **{'width': 3}),

        wm('account_frame', 'operator', 'label', 1, 1, 0, 0, 'nsew', **{'text': 'Operator'}),
        wm('account_frame', entry_operator_w, 'entry', 1, 1, 1, 1, 'nsew', **{'width': 3}),
        wm('account_frame', entry_operator_h, 'entry', 1, 1, 2, 2, 'nsew', **{'width': 3}),
        wm('account_frame', entry_operator_font_size, 'entry', 1, 1, 3, 3, 'nsew', **{'width': 3}),

        wm('account_frame', 'constant', 'label', 2, 2, 0, 0, 'nsew', **{'text': 'Constant'}),
        wm('account_frame', entry_constant_w, 'entry', 2, 2, 1, 1, 'nsew', **{'width': 3}),
        wm('account_frame', entry_constant_h, 'entry', 2, 2, 2, 2, 'nsew', **{'width': 3}),
        wm('account_frame', entry_constant_font_size, 'entry', 2, 2, 3, 3, 'nsew', **{'width': 3}),

        wm('account_frame', 'bb', 'label', 3, 3, 0, 0, 'nsew', **{'text': 'BB'}),
        wm('account_frame', entry_bb_w, 'entry', 3, 3, 1, 1, 'nsew', **{'width': 3}),
        wm('account_frame', entry_bb_h, 'entry', 3, 3, 2, 2, 'nsew', **{'width': 3}),
        wm('account_frame', entry_bb_font_size, 'entry', 3, 3, 3, 3, 'nsew', **{'width': 3}),
